// backend/server.js (Versión Final, 100% Corregida)
...
function prepareDataForSheet(balancesDeEstaEntidad, cuentasMap, nominaMap, allMonths, indicesMap, num_entidad) {
    ...
    dataForSheet.push(['Saludos ... Para cualquier consulta, sugerencia o para reportar algún error, Vincenzo está siempre disponible en vnatale52@gmail.com']);
    return dataForSheet;
}
